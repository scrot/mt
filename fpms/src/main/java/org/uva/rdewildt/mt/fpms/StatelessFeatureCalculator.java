 ...
 */
public class StatelessFeatureCalculator extends MetricCalculator implements FeatureCalculator {
    private final Map<String, Feature> features;

    public StatelessFeatureCalculator(Path binaryRoot, Path gitRoot, Boolean ignoreGenerated, Boolean ignoreTests, Boolean onlyOuterClasses) throws Exception {
